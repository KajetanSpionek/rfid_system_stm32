...
* Handles communication with RFID RC522 module
*/
...
#define MFRC522_CS_LOW HAL_GPIO_WritePin(GPIOE, GPIO_PIN_4, GPIO_PIN_RESET)
#define MFRC522_CS_HIGH HAL_GPIO_WritePin(GPIOE, GPIO_PIN_4, GPIO_PIN_SET)
